...
const Search = () => {
  ...
  const fetchData = (
    ...
    axios
      .get(
        `${process.env.REACT_APP_BACKEND_URL}/movies-admin?page=${pageParams}&limit=17&folder=${folderParams}&title=${titleParams}&available=${availableParams}&sortQuery=${sortQueryParams}&ascDesc=${ascDescParams}`,
        {
          headers: {
    ...
    <MediaSt>
      ...
      <DashboardSt>
        ...
        <section className="cell-label-input">
          ...
          <Link className="select-arrow addMedia" to="/admin/add-media">
            Agregar
          </Link>
        </section>
      </DashboardSt>
